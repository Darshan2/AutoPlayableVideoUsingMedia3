...
public interface Playable extends PlayabilityStateChangeObserver {
    ...
    /**
     * Releases the {@link Player} associated with this item.
     ...
     * (Tags are used to help to differentiate the {@link Player}s within the Player Pool,
    ...
    /**
     * Determines whether the current item can manage the {@link Player}'s
