...
package com.example.videoplayerusingmedia3.demo.util.misc
 ...
 *
 */
fun randomFloat(includeNegativeNumbers: Boolean = true) =
    (if (includeNegativeNumbers) Float.MIN_VALUE else 0.0F).randomUpTo(Float.MAX_VALUE)
 ...
 *
 */
fun randomDouble(includeNegativeNumbers: Boolean = true) =
    (if (includeNegativeNumbers) Double.MIN_VALUE else 0.0).randomUpTo(Double.MAX_VALUE)
